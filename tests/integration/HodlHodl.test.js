...
describe('HodlHodl API', function() {
  ...
  it('can accept offer', async () => {
    ...
    // console.warn(offer.payment_method_instructions[0]);
    ...
    // console.warn({paymentMethodInstructionId});
    // let instructions = await Hodl.getPaymentMethodInstructions(paymentMethodInstructionId);
    // console.warn(instructions); return;
    // let paymentMethodInstructionVersion = 1488;
    let volume = 0.005;
